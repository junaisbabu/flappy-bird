...
function resetAllAnimations() {
  ...
  const blockAnimationsCss = `blockAnimation ${seconds}s infinite linear`;

  block.style.animation = blockAnimationsCss;
  hole.style.animation = blockAnimationsCss;
...
function startBgAnimation() {
    game.style.animation = 'backgroundAnimation 8s infinite linear'
}
